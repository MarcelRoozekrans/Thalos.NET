...
/// runs first because <see cref="OrmWorkflowStore.CompleteNodeAsync"/> enqueues into it in the same transaction
/// as the workflow tables it depends on being present.
/// </summary>
